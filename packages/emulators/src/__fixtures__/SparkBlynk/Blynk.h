// Blynk.h — Sparklab compatibility shim. A standard Blynk sketch that does `#include <Blynk.h>` gets the
...
#ifndef SPARK_BLYNK_COMPAT_Blynk_H
#define SPARK_BLYNK_COMPAT_Blynk_H
