// BlynkSimpleEsp32.h — Sparklab compatibility shim. A standard Blynk sketch that does `#include <BlynkSimpleEsp32.h>` gets the
...
#ifndef SPARK_BLYNK_COMPAT_BlynkSimpleEsp32_H
#define SPARK_BLYNK_COMPAT_BlynkSimpleEsp32_H
